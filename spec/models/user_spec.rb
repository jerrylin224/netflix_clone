...
describe User do
  ...
  it "generates a random token when the user is created" do
    ...
    expect(charlie.token).to be_present
  end
  ...
  describe "#another_user" do
    it "returns true if the user has a following reloationship with another user" do
      ...
      expect(charlie.follows?(bob)).to be true
    end
    ...
    it "returns false if the user doesn't have a following relationship with another user" do
      ...
      expect(charlie.follows?(bob)).to be false
    end
  end
  ...
  describe "#follow" do
    ...
    it "does not follow one self" do
      ...
      expect(charlie.follows?(charlie)).to be false
    end
  end
end
